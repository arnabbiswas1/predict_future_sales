"""
Benchamrk with LGB item_cnt_month clipped between o to 20, validation on month before test (33).
...
SEED = 42
EXP_DETAILS = "Benchamrk with LGB item_cnt_month clipped between o to 20, validation on last month (33). Final model is built using all data (including month 33)"
IS_TEST = False
...
common.save_file(logger, submission, constants.SUBMISSION_DIR, f"sub_{MODEL_NAME}_{RUN_ID}_lgb_baseline_full_training_data.csv")
